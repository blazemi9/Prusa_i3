...
// 14 Czech
	...
	#define LANGUAGE_CHOICE 14  // Pick your language from the list above
#endif
...
// Please note these are limited to 17 characters!
	...
	#define MSG_PREHEAT_PLA012 "Predehrev PLA Vse"
	#define MSG_PREHEAT_PLA_BEDONLY "Predehrev PLA Bed"
	#define MSG_PREHEAT_PLA_SETTINGS "Predehrev PLA konf"
	...
	#define MSG_PREHEAT_ABS012 "Predehrev ABS Vse"
	#define MSG_PREHEAT_ABS_BEDONLY "Predehrev ABS Bed"
	#define MSG_PREHEAT_ABS_SETTINGS "Predehrev ABS konf"
	#define MSG_COOLDOWN "Zchladit"
	#define MSG_SWITCH_PS_ON "Vypnout"
	#define MSG_SWITCH_PS_OFF "Zapnout"
	...
	#define MSG_ESTEPS "Esteps/mm"
	#define MSG_RECTRACT "Rectract"
	#define MSG_TEMPERATURE "Templota"
	#define MSG_MOTION "Pohyb"
	#define MSG_CONTRAST "LCD kontrast"
	#define MSG_STORE_EPROM "Ulozit pamet"
	#define MSG_LOAD_EPROM "Nacist pamet"
	...
	#define MSG_PAUSE_PRINT "Pozastavit"
	#define MSG_RESUME_PRINT "Pokracovat"
	#define MSG_STOP_PRINT "Zastavit"
	#define MSG_CARD_MENU "Tisk z SD"
	#define MSG_NO_CARD "Karta nenalezena"
	#define MSG_DWELL "Sleep..."
	#define MSG_USERWAIT "Wait for user..."
	#define MSG_RESUMING "Obnoveni tisku"
	#define MSG_NO_MOVE "No move."
	#define MSG_KILLED "Ukonceno. "
	...
	#define MSG_INIT_SDCARD "Inicializace SD"
	#define MSG_CNG_SDCARD "Vymena SD karty"
	#define MSG_ZPROBE_OUT "Z probe out. bed"
	#define MSG_POSITION_UNKNOWN "Home X/Y pred Z"
	#define MSG_ZPROBE_ZOFFSET "Z Offset"
	#define MSG_BABYSTEP_X "Babystep X"
	#define MSG_BABYSTEP_Y "Babystep Y"
	#define MSG_BABYSTEP_Z "Babystep Z"
...
// Serial Console Messages
	...
	#define MSG_SOFTWARE_RESET " Software Reset"
	#define MSG_AUTHOR " | Author: "
	#define MSG_CONFIGURATION_VER " Posledni update: "
	#define MSG_FREE_MEMORY " Volna pamet: "
	#define MSG_PLANNER_BUFFER_BYTES "  Velikost Panner bufferu: "
	#define MSG_OK "ok"
	#define MSG_FILE_SAVED "Ukladani souboru dokonceno."
	#define MSG_ERR_LINE_NO "Line Number is not Last Line Number+1, Last Line: "
	#define MSG_ERR_CHECKSUM_MISMATCH "checksum chyba, Posledni radek: "
	#define MSG_ERR_NO_CHECKSUM "Chybi Checksum, Posledni Line: "
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM "Chybi radek k checksum, Posledni Line: "
	#define MSG_FILE_PRINTED "Tisk souboru dokoncen"
	#define MSG_BEGIN_FILE_LIST "Zacatek seznamu souboru"
	#define MSG_END_FILE_LIST "Konec seznamu souboru"
	#define MSG_M104_INVALID_EXTRUDER "M104 Chybny extruder "
	#define MSG_M105_INVALID_EXTRUDER "M105 Chybny extruder "
	#define MSG_M200_INVALID_EXTRUDER "M200 Chybny extruder "
	#define MSG_M218_INVALID_EXTRUDER "M218 Chybny extruder "
	#define MSG_M221_INVALID_EXTRUDER "M221 Chybny extruder "
	#define MSG_ERR_NO_THERMISTORS "Chybi termistory"
	#define MSG_M109_INVALID_EXTRUDER "M109 Chybny extruder "
	#define MSG_HEATING "Nahrivani..."
	#define MSG_HEATING_COMPLETE "Nahrivani dokonceno."
	#define MSG_BED_HEATING "Nahrivani bed."
	#define MSG_BED_DONE "Nahrivani Bed dokonceno."
	#define MSG_M115_REPORT "FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X " Pocitadlo X: "
	#define MSG_ERR_KILLED "Tiskarna zastavena. kill() zavolano!"
	#define MSG_ERR_STOPPED "Tiskarna zastave z duvodu chyby. Opravte chybu a zkuste M999 pro restart. (Teploty resetovany, nastavte po resetu znovu)"
	#define MSG_RESEND "Proposlano: "
	#define MSG_UNKNOWN_COMMAND "Neznamy prikaz: \""
	#define MSG_ACTIVE_EXTRUDER "Aktivni Extruder: "
	#define MSG_INVALID_EXTRUDER "Chybny extruder"
	#define MSG_X_MIN "x_min: "
	#define MSG_X_MAX "x_max: "
	#define MSG_Y_MIN "y_min: "
	#define MSG_Y_MAX "y_max: "
	#define MSG_Z_MIN "z_min: "
	#define MSG_Z_MAX "z_max: "
	#define MSG_M119_REPORT "Vypis stavu endstopu"
	#define MSG_ENDSTOP_HIT "SEPNUTY"
	#define MSG_ENDSTOP_OPEN "otevreny"
	#define MSG_HOTEND_OFFSET "Hotend offsety:"

	#define MSG_SD_CANT_OPEN_SUBDIR "Nelze otevrit podslozku"
	#define MSG_SD_INIT_FAIL "Inicializace SD selhala"
	#define MSG_SD_VOL_INIT_FAIL "Inicializace svazku na SD selhala"
	#define MSG_SD_OPENROOT_FAIL "Otevreni korenoveho adresare selhalo"
	#define MSG_SD_CARD_OK "SD karta OK"
	#define MSG_SD_WORKDIR_FAIL "Otevreni pracovniho adresare selhalo"
	#define MSG_SD_OPEN_FILE_FAIL "Selhalo otevreni souboru: "
	#define MSG_SD_FILE_OPENED "Soubor otevren: "
	#define MSG_SD_SIZE " Velikost: "
	#define MSG_SD_FILE_SELECTED "Soubor vybran"
	#define MSG_SD_WRITE_TO_FILE "Zapis do souboru: "
	#define MSG_SD_PRINTING_BYTE "SD tiskovy byte "
	#define MSG_SD_NOT_PRINTING "Zadny tisk z SD"
	#define MSG_SD_ERR_WRITE_TO_FILE "Chyba pri zapisu do souboru"
	#define MSG_SD_CANT_ENTER_SUBDIR "Nelze vstoupit do podslozky: "

	#define MSG_STEPPER_TOO_HIGH "Frekvence stepu moc vysoka: "
	#define MSG_ENDSTOPS_HIT "Endstopy sepnuty: "
	#define MSG_ERR_COLD_EXTRUDE_STOP " Ochrana studene extruze, ujistete se ze teplota trysky je vetsi nez 80'C"
	#define MSG_ERR_LONG_EXTRUDE_STOP " Ochrana velmi dlouhe extruze"
	#define MSG_BABYSTEPPING_X "Babystepping X"
	#define MSG_BABYSTEPPING_Y "Babystepping Y"
	#define MSG_BABYSTEPPING_Z "Babystepping Z"
	#define MSG_SERIAL_ERROR_MENU_STRUCTURE "Chyba v strukture nabidky"
